...
//         <button onClick={prevEvent} className="arrow-button left-arrow">&lt;</button>
...
//           ))}
//           </div>
//           <button onClick={nextEvent} className="arrow-button right-arrow">&gt;</button>
//         </div>
//       </div>
...
//         {/* <button className="left-arrow" onClick={prevEvent}>&lt;</button> */}
...
//             /> 
//           ))}
//           {/* <button className="right-arrow" onClick={nextEvent}>&gt;</button> */}
...
//   {
//     title: "Career Orientation Session",
//     description: "Student Welfare Group conducts the Career Orientation Session for 2nd and 3rd year students...",
//     images: [imgcos1, imgcos2, imgcos3],
//   },
//   {
//     title: "Examania",
//     description: "In this program, we ask the students who scored a good CGPA and have aced their Academics in previous years...",
//     images: [imgex1, imgex2, imgex3],
//   },
//   {
//     title: "Foresight",
//     description: "In this series, we ask our seniors about their CDC placements and Internships...",
//     images: [imgfr1, imgfr2, imgfr3],
//   },
//   {
//     title: "ELAT",
//     description: "Student Welfare Group's ELAT initiative assesses your English proficiency...",
//     images: [imgel1, imgel2, imgel3],
//   },
// ];
...
//         <button onClick={prevEvent} className="nav-button">
...
//         <button onClick={nextEvent} className="nav-button">
...
//         <div className={`event-container ${currentIndex % 2 === 0 ? "left" : "right"}`}>
//           {/* Event Info */}
...
//             {events[currentIndex].images.map((image, index) => (
//               <div key={`${currentIndex}-${index}`} className="image-wrapper">
//                 <img src={image} alt={`Event ${currentIndex + 1} - Image ${index + 1}`} className="event-image" />
//               </div>
//             ))}
//           </div>
//         </div>
    ...
    <div className="app">
      <nav className="navigation">
        <div className="nav-container">
          <button onClick={prevEvent} className="nav-arrow">
            <ChevronLeft />
          </button>
          ...
          <button onClick={nextEvent} className="nav-arrow">
            <ChevronRight />
          </button>
        </div>
      </nav>
      ...
      <main className="content">
        <div className={`event-container ${currentIndex % 2 === 0 ? '' : 'reverse'}`}>
          <div className="event-info">
            <div className="event-text" key={currentIndex}>
              <h2 className="event-title">{events[currentIndex].title}</h2>
              <p className="event-description">{events[currentIndex].description}</p>
            </div>
          </div>

          <div className="event-images">
            <div className="images-container" key={currentIndex}>
              {events[currentIndex].images.map((image, index) => (
                <div key={`${currentIndex}-${index}`} className="image-wrapper">
                  <img
                    src={image}
                    alt={`Event ${currentIndex + 1} - Image ${index + 1}`}
                  />
                </div>
              ))}
            </div>
